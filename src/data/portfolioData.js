    ...
    media: [
      {
        ...
        caption: 'Hard light, architecture, and street geometry treated as studies in rhythm, texture, and composition.',
      },
      {
        type: 'photo',
        src: '',
        ...
        caption: 'Wide environmental frames focused on weather, mountain silhouettes, skyline layers, and atmospheric depth.',
      },
      {
        type: 'video',
        src: '',
        ...
        caption: 'Short motion notes preserve camera movement, ambient detail, and environmental reference gathered on foot.',
      },
    ],
  },
  {
    ...
    media: [
      {
        ...
        caption: 'Draft context connects an essay or notebook fragment to the workspace, references, and questions behind it.',
      },
      {
        type: 'photo',
        src: '',
        ...
        caption: 'Essay covers frame the central idea behind a technical reflection, project narrative, or creative sketch.',
      },
      {
        type: 'video',
        src: '',
        ...
        meta: 'Video / Process',
        caption: 'Process notes can pair a reading excerpt or recorded thought with the written piece that followed it.',
      },
    ],
  },
  {
    ...
    media: [
      {
        ...
        caption: 'Routes, trail references, and arrival frames anchor each location-specific field log.',
      },
      {
        type: 'video',
        src: '',
        ...
        meta: 'Video / Movement',
        caption: 'Movement studies hold the weather, terrain, road rhythm, and arrival moments that still images leave between frames.',
      },
      {
        type: 'photo',
        src: '',
        ...
        caption: 'Small details make a place specific: textures, signs, rituals, meals, and quiet moments between destinations.',
      },
    ],
  },
];

...
`;function vm(){const e=om(),t=T.useMemo(()=>Ts(e),[e]),[n,r]=T.useState(null),i=n||t,o=am(),a=sm(),[l,s]=T.useState("snowboard"),[f,h]=T.useState("snow"),[v,m]=T.useState(1),[y,p]=T.useState(!1),[k,A]=T.useState(!1),[d,c]=T.useState(!1),[g,x]=T.useState(!1),[b,S]=T.useState("idle"),[P,j]=T.useState(""),[Q,O]=T.useState(null),[pe,tt]=T.useState(Wn[0].id),Ie=Wn.find(nt=>nt.id===pe)||Wn[0];um(),lm(),T.useEffect(()=>{const nt=be=>{var Qe,E;if(be.altKey){if(be.key==="ArrowDown"){be.preventDefault();const _=qe[Math.min(qe.length-1,a+1)];(Qe=document.getElementById(_.id))==null||Qe.scrollIntoView({behavior:"smooth"})}if(be.key==="ArrowUp"){be.preventDefault();const _=qe[Math.max(0,a-1)];(E=document.getElementById(_.id))==null||E.scrollIntoView({behavior:"smooth"})}}};return window.addEventListener("keydown",nt),()=>window.removeEventListener("keydown",nt)},[a]);async function tn(){if(!("geolocation"in navigator)){j("Live weather needs browser geolocation support."),S("error");return}S("loading"),j(""),navigator.geolocation.getCurrentPosition(async nt=>{try{const{latitude:be,longitude:Qe}=nt.coords,E=`https://api.open-meteo.com/v1/forecast?latitude=${be}&longitude=${Qe}&current=temperature_2m,weather_code,wind_speed_10m,precipitation,rain,snowfall,cloud_cover,is_day&timezone=auto`,_=await fetch(E);if(!_.ok)throw new Error("Weather request failed");const M=await _.json(),B=M.current||{},[Z,N]=td[B.weather_code]||["Current weather","clear"],L=await rm(be,Qe,M.timezone),F={condition:Z,kind:N,temp:B.temperature_2m??0,wind:B.wind_speed_10m??0,location:L,code:B.weather_code},D=B.time?Ts(new Date(B.time)):null;r(D||(B.is_day===0?{key:"night",label:"Night"}:B.is_day===1?{key:"day",label:"Day"}:null)),O(F),S("synced"),cm(N,s,h,m)}catch{S("error"),j("Live weather could not be loaded. The scene still uses local time.")}},()=>{S("error"),j("Location permission was not granted. Manual ambience remains active.")},{enableHighAccuracy:!1,timeout:1e4,maximumAge:30*60*1e3})}return u.jsxs("main",{className:`site ${l} ${i.key} ${y?"fall-theme":""} ${k?"spring-theme":""} ${d?"winter-theme":""}`,children:[u.jsx("style",{children:dm}),u.jsx("style",{children:pm}),u.jsx("style",{children:fm}),u.jsx("style",{children:mm}),u.jsx("style",{children:gm}),u.jsx("style",{children:hm}),u.jsx(im,{mode:l,weather:f,weatherPower:v,activeSector:a,scrollProgress:o,timeProfile:i,fallTheme:y,springTheme:k,winterTheme:d}),u.jsx("div",{className:"portrait-background","aria-hidden":"true",children:u.jsx("img",{src:Lf,alt:""})}),u.jsx("div",{className:"ambient-grid","aria-hidden":"true"}),u.jsxs("header",{className:"nav-shell",children:[u.jsxs("a",{className:"brand",href:"#hero",children:[u.jsx(js,{}),u.jsxs("span",{children:[u.jsx("strong",{children:le.name}),u.jsx("small",{children:"Engineer · Builder · Problem Solver"})]})]}),u.jsx("a",{className:"nav-cta",href:le.resume,download:!0,children:"Download CV"})]}),u.jsx(Wf,{activeSector:a,activeContentTab:Ie}),u.jsx(Vf,{weather:f,setWeather:h,weatherPower:v,setWeatherPower:m,activeSector:a,liveWeather:Q,timeProfile:i,weatherStatus:b,weatherError:P,onUseLiveWeather:tn,onInteract:()=>x(!0),fallTheme:y,setFallTheme:p,springTheme:k,setSpringTheme:A,winterTheme:d,setWinterTheme:c}),u.jsx(Hf,{activeSector:a,activeContentTab:Ie,hudInteracted:g}),u.jsx("section",{id:"hero",className:"sector hero-sector",children:u.jsxs("div",{className:"hero-copy",children:[u.jsx("p",{className:"eyebrow",children:"// Backend · Game Tech · Data Systems"}),u.jsx("h1",{children:le.name}),u.jsxs("h2",{children:[u.jsx("span",{children:le.title})," ",le.tagline]}),u.jsx("p",{className:"hero-lede",children:"I build reliable backend services, content pipelines, and developer-facing tools that connect cloud-native engineering with game-production workflows."}),u.jsxs("div",{className:"hero-actions",children:[u.jsx("a",{className:"primary-action",href:"#tab-content",children:"Start exploring →"}),u.jsx("a",{href:le.resume,download:!0,children:"Download Resume"}),u.jsx("a",{href:le.github,...ii(le.github),children:"GitHub"})]})]})}),u.jsxs("section",{id:"tab-content",className:"sector section-wrap tab-content",role:"tabpanel","aria-labelledby":`profile-tab-${Ie.id}`,children:[u.jsx(Xf,{tabs:Wn,activeTabId:pe,onTabChange:tt}),u.jsx(nm,{tab:Ie})]}),u.jsxs("footer",{id:"contact",className:"sector footer-shell panel-card","data-tilt":!0,children:[u.jsxs("div",{children:[u.jsx(js,{}),u.jsx("h2",{children:"Let’s build online systems and game technology that scale."}),u.jsx("p",{children:le.location})]}),u.jsxs("div",{className:"contact-links",children:[u.jsx("a",{href:Wc(le.email),children:le.email}),u.jsx("a",{href:le.linkedin,...ii(le.linkedin),children:"LinkedIn"}),u.jsx("a",{href:le.github,...ii(le.github),children:"GitHub"})]})]}),u.jsx("div",{className:"scroll-finish-spacer","aria-hidden":"true"})]})}Vc(document.getElementById("root")).render(u.jsx(wd.StrictMode,{children:u.jsx(vm,{})}));
